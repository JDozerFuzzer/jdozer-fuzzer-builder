#!/bin/bash
# This script is used to build and run the fuzzer application in Docker containers.
# It creates a Docker network and builds the necessary images for the application components.
